...
void CMyLabel::wheelEvent(QWheelEvent *ev)
{
    ...
    SetCheck("~give_error");
    Herror ret = Hee(mouseRow, mouseCol, Button);
    SetCheck("give_error");
...
void CMyLabel::mouseMoveEvent(QMouseEvent *ev)
{
    ...
    HTuple pointGray;
    SetCheck("~give_error");
    ret = Hee(mouseRow, mouseCol, pointGray);
    SetCheck("give_error");
...
Herror CMyLabel::Hee(HTuple &mouseRow, HTuple &mouseCol, HTuple &Button)
{
    Herror ret;
    try
    {
